...
const Button = ({ 
  ...
  const baseClasses = 'inline-flex items-center justify-center font-medium rounded-lg transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-offset-1 focus:ring-offset-dark-900 dark:focus:ring-offset-dark-950';
  ...
  // Variant classes with modern styling and light/dark mode support
  const variantClasses = {
    ...
    outline: 'border border-light-300 dark:border-dark-600 hover:border-primary-500 text-dark-800 dark:text-white hover:bg-primary-500/10 focus:ring-primary-500',
    
    glass: 'bg-light-100/70 dark:bg-dark-800/50 backdrop-blur-sm border border-light-200/70 dark:border-dark-700/50 hover:bg-light-200/70 dark:hover:bg-dark-700/50 text-dark-800 dark:text-white shadow-glass-sm hover:shadow-glass focus:ring-primary-500/20 dark:focus:ring-white/20',
    
    ghost: 'bg-transparent hover:bg-light-100/70 dark:hover:bg-dark-800/50 text-dark-700 dark:text-white focus:ring-light-300/50 dark:focus:ring-white/20',
